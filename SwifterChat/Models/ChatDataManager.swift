...
class ChatDataManager {
    ...
    var chatMessages = [ChatEntry(chatMessage: "A long time ago in a galaxy far, far away.", outgoingMessage: true),
        ChatEntry(chatMessage: "It is a period of civil war. Rebel spaceships, striking from a hidden base, have won their first victory against the evil Galactic Empire.", outgoingMessage: false),
